    ...
    <div class="flex items-center gap-2.5 mb-2 bg-[#1C1611] border border-[#2A211A] p-2 rounded-xl">
        ...
        <div class="min-w-0 flex-1">
            <div class="title-marquee-wrap track-row-marquee">
                <span class="title-marquee-text text-[11px] font-bold text-[#FAF7F2] leading-tight"
    ...
    <div class="flex items-center justify-between gap-1.5">
        ...
        <div class="flex items-center gap-1.5">
            <button type="button"
                    ...
                    class="text-[#A89A85] hover:text-[#D9973E] transition p-0.5 flex items-center justify-center cursor-pointer">
...
(function initMarqueeHoverWidget() {
